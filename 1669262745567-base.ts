...
export class base1669262745567 implements MigrationInterface {
  name = 'base1669262745567';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "administrador" 
        ( 
            "pk_administrador" int NOT NULL IDENTITY(1,1), 
            "nombre" nvarchar(50) NOT NULL, 
            "apellido" nvarchar(50) NOT NULL, 
            "correo" nvarchar(100) NOT NULL, 
            "usuario" nvarchar(50) NOT NULL, 
            "estado" nvarchar(50) NOT NULL CONSTRAINT "DF_e3d37bf26640b81f7e8ef763271" DEFAULT 'Deshabilitado', 
            CONSTRAINT "PK_78cf0366d2bc4801b5110bd7668" PRIMARY KEY ("pk_administrador"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "horario" ("pk_horario" int NOT NULL IDENTITY(1,1), "fecha" date NOT NULL, "hora_inicio" time NOT NULL, "hora_fin" time NOT NULL, "fk_grupo" int, CONSTRAINT "ck_hora_inicio_fin" CHECK (hora_fin>hora_inicio), CONSTRAINT "PK_733515f51ed89bb896cb32b9ea9" PRIMARY KEY ("pk_horario"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "pregunta" ("pk_pregunta" int NOT NULL IDENTITY(1,1), "pregunta" nvarchar(500) NOT NULL, "categoria" nvarchar(50) NOT NULL, "tipo" nvarchar(50) NOT NULL, "estado" nvarchar(50) NOT NULL, "orden" int, CONSTRAINT "ck_estado_pregunta" CHECK (estado='Deshabilitado' OR estado='Habilitado'), CONSTRAINT "PK_e55dc3817a9212048ad01b41f87" PRIMARY KEY ("pk_pregunta"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "sector" ("pk_sector" int NOT NULL IDENTITY(1,1), "nombre" nvarchar(100) NOT NULL, CONSTRAINT "PK_8933a5c96cda9ca139b74be3188" PRIMARY KEY ("pk_sector"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "ubicacion" ("pk_ubicacion" int NOT NULL IDENTITY(1,1), "nombre" nvarchar(50) NOT NULL, "fk_pais" int, "ubicacionesPkSalon" int, CONSTRAINT "pk_ubicacion" PRIMARY KEY ("pk_ubicacion"))`,
    );
    await queryRunner.query(
    ...
    // ADD CONSTRAINTS
    await queryRunner.query(
      `ALTER TABLE "empresa" ADD CONSTRAINT "fk_empresa_sector" FOREIGN KEY ("fk_sector") REFERENCES "sector"("pk_sector") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "horario" ADD CONSTRAINT "fk_horario_grupo" FOREIGN KEY ("fk_grupo") REFERENCES "grupo"("pk_grupo") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "ubicacion" ADD CONSTRAINT "fk_salon_ubicacion" FOREIGN KEY ("fk_pais") REFERENCES "ubicacion"("pk_ubicacion") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "grupo" ADD CONSTRAINT "fk_grupo_curso" FOREIGN KEY ("fk_curso") REFERENCES "curso"("pk_curso") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "grupo" ADD CONSTRAINT "fk_grupo_salon" FOREIGN KEY ("fk_salon") REFERENCES "salon"("pk_salon") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "grupo" ADD CONSTRAINT "fk_grupo_instructor" FOREIGN KEY ("fk_instructor") REFERENCES "instructor"("pk_instructor") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "clase" ADD CONSTRAINT "fk_clase_empresa" FOREIGN KEY ("fk_empresa") REFERENCES "empresa"("pk_empresa") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "certificado" ADD CONSTRAINT "fk_certificado_clase" FOREIGN KEY ("fk_grupo") REFERENCES "clase"("pfk_grupo") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "certificado" ADD CONSTRAINT "fk_certificado_clase" FOREIGN KEY ("fk_estudiante") REFERENCES "clase"("pfk_estudiante") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "encuesta" ADD CONSTRAINT "fk_encuesta_pregunta" FOREIGN KEY ("fk_pregunta") REFERENCES "pregunta"("pk_pregunta") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "encuesta" ADD CONSTRAINT "fk_encuesta_clase" FOREIGN KEY ("fk_grupo") REFERENCES "clase"("pfk_grupo") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "encuesta" ADD CONSTRAINT "fk_encuesta_clase" FOREIGN KEY ("fk_estudiante") REFERENCES "clase"("pfk_estudiante") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "encuesta" DROP CONSTRAINT "fk_encuesta_clase"`,
    );
    await queryRunner.query(
      `ALTER TABLE "encuesta" DROP CONSTRAINT "fk_encuesta_clase"`,
    );
    await queryRunner.query(
      `ALTER TABLE "encuesta" DROP CONSTRAINT "fk_encuesta_pregunta"`,
    );
    await queryRunner.query(
      `ALTER TABLE "certificado" DROP CONSTRAINT "fk_certificado_clase"`,
    );
    await queryRunner.query(
      `ALTER TABLE "certificado" DROP CONSTRAINT "fk_certificado_clase"`,
    );
    await queryRunner.query(
      `ALTER TABLE "clase" DROP CONSTRAINT "fk_clase_empresa"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "grupo" DROP CONSTRAINT "fk_grupo_instructor"`,
    );
    await queryRunner.query(
      `ALTER TABLE "grupo" DROP CONSTRAINT "fk_grupo_salon"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "ubicacion" DROP CONSTRAINT "fk_salon_ubicacion"`,
    );
    await queryRunner.query(
      `ALTER TABLE "horario" DROP CONSTRAINT "fk_horario_grupo"`,
    );
    await queryRunner.query(
      `ALTER TABLE "empresa" DROP CONSTRAINT "fk_empresa_sector"`,
    );
