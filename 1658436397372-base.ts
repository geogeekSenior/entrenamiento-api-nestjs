...
export class base1658436397372 implements MigrationInterface {
  name = 'base1658436397372';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "ubicacion" ("pk_ubicacion" int NOT NULL IDENTITY(1,1), "nombre" nvarchar(50) NOT NULL, "fk_pais" int, "ubicacionesPkSalon" int, CONSTRAINT "PK_56064dfa6442817b6cc45427eb1" PRIMARY KEY ("pk_ubicacion"))`,
    );
    await queryRunner.query(
